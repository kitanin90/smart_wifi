    ...
    if request.method == 'POST':
        ...
        for row in reader:
            ...
            list_facultys = {
                ...
                'OZSГРП': 'ЮФ', 'ZОГМВ': 'ЮФ', 'ZЮПД': 'ЮФ', 'OZГОС': 'ЮФ', 'OZГРП': 'ЮФ', 'ZSГОС': 'ЮФ', 'ZПОГМВ': 'ЮФ',
            ...
            list_building = {
                ...
                'ZБЯ': 'Главный корпус', 'ИСТО': 'Главный корпус',
                ...
                'МФ': 'Корпус ФМиИТ', 'ПИ': 'Корпус ФМиИТ',
                ...
                'OZГРП': 'Корпус ЮФ', 'ZSГОС': 'Корпус ЮФ',
                'ZГРП': 'Корпус ЮФ', 'ZГОС': 'Корпус ЮФ', 'ZSГРП': 'Корпус ЮФ',
            ...
            # str_bad_group = re.sub(r"\d+", "", name_group, flags=re.UNICODE)   # Удаляет символы из строки
            # string = re.findall(r'-(\w+)', str_bad_group)
            # group_in_csv = ''.join(string)
